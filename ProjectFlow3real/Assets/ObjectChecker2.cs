...
public class ObjectChecker2 : MonoBehaviour //script checks to see if the button can be pressed or not
{
	...
	void Change(){
        ...
        Debug.Log(r);
        Debug.Log(GlobalVariable.pointsP2);
        if (r == 1){
